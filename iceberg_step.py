...
df.writeTo("local.nyc.taxis_step1").create()
...
#print(f"\n\n****   Open : ", chemin_absolu)
    ...
    trips_df1.writeTo("local.nyc.taxis_step1").append()


df = spark.table("local.nyc.taxis_step1")

spark.sql("select * from local.nyc.taxis_step1.history").show()
