...
spark.sql("DESCRIBE local.nyc.tempo_yellow").show()
...
parquet_path=f"hdfs://mycluster:8020/user/tdp_user/warehouse_hadoop_iceberg/nyc/tempo_yellow/data/tpep_pickup_datetime_month=????-??"
...
for fileStatus in status:
    ...
    if period  is not None :
        ...
        output_path = f"hdfs://mycluster:8020/user/tdp_user/data/my_nyc_yellow_taxi_trip_corrected/yellow_tripdata_{period}.parquet"
